...
help:: ##@Usage show this help
	@echo ""
	@printf "%30s \n\n" "${TURQUOISE}VARIABLES"
	@printf "%134s \n" "DATA_DIR  set the DATA_DIR variable to the mounted path of the dataset, default is the path ('/app/data/data_bucket')"
	@printf "%67s \n" "PORT  set the external port redirected to 8888"
	@printf "%81s \n" "SERVICE  docker-compose service to use, default is ('dev_gpu1')"
	@printf "%93s \n" "FILE  path to the input file to use for a given command, default is ('')"
	@echo "${RESET}"
	@echo ""
